...
var ieTransforms = {
    ...
    useIeTransforms = (jQuery.browser.msie && parseInt(jQuery.browser.version, 11) <= 8);
...
$.ui.iviewer.ImageObject = function(do_anim) {
    this._img = $("<img id='ivImg'>")
            //this is needed, because chromium sets them auto otherwise
            .css({ position: "absolute"});  // , top :"5px", left: "5px"
