        ...
        <@panelBody>
            <@tab id="tab">
                ...
                <div style="padding-bottom:0px;"></div>
                    <@form id="uploadForm" enctype="multipart/form-data" action="/assets/cmp_/uploadImage?sgin=assetsUpload" success_url="/assets/cmp_/content/${(tmCmpMain.batchNo)!}/${(systemId)!}/${(userNo)!}/${(branchCode)!}">
                        ...
                        <@submitButton name="上传提交"/>
                            <@href name="返回查看" href="/assets/cmp_/content/${(tmCmpMain.batchNo)!}/${(systemId)!}/${(userNo)!}/${(branchCode)!}"/>
                    </@form>
    ...
    <#--var upload = function () {-->
        ...
        <#--$.ajax({-->
            ...
            <#--success: function (ref) {-->
                <#--if (ref.s) {&lt;#&ndash;如果成功&ndash;&gt;-->
                    <#--alert(ref.msg);-->
                <#--} else {-->
                    <#--alert(ref.msg);&lt;#&ndash;如果失败，则显示失败原因&ndash;&gt;-->
